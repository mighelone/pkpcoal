...
# first argument is k, second is t_start, third final yield
EvACRMin = [5, 1e-5]
...
EvAKobInit = [100157.0037, 5849.84292004,
              85011813.05, 12648.7543183, 0.45, 0.65]
#
# For Kobayashi:
# one less pair; the range is set from minimum yields to maximum yields
# in Pyrolysis.py
EvADAEMMin = [10, 150e6, 15e6]
# one less pair; the range is set from minimum yields to maximum yields
# in Pyrolysis.py
EvADAEMMax = [15, 300e6, 50e6]
...
# initial guess vector of Gradient based optimization is the ...Init
# vector defined for the Evolutionary algorithm

# see
# http://docs.scipy.org/doc/scipy/reference/optimize.html#module-scipy.optimize
selectedGradBasedOpt = 'fmin'
#selectedGradBasedOpt = 'brute'
#selectedGradBasedOpt = 'leastsq'
# possible inputs: 'fmin' or 'leastsq' (recommended) ;
# 'fmin_cg','fmin_bfgs','fmin_ncg','fmin_slsqp'
...
# set this parameter True for having a gradient-based optimization after
# the GA optimization
optimizGrad = False
