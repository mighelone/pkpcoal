...
class CPDResult(PreProcResult):
    ...
    def __init__(self, coal, runNr,
        ...
        '''
        :param coal: coal object
        :param runNr: runName string
        :param folder: folder where data are saved (default = None)
        :param dct: results data dct = {'header': {'ftot': val, ...}, 'data': data_results}
        '''
        self.coal = coal
    ...
    def readResults(cls, fn):
        ...
        :param fn: result file to read
        :return numpy.array containing file results
        """
    ...
    def interpolate(self, field):
        ...
        :param field: data field label; example: 'Temp'
        :return: scipy.interpolate.interp1d scipy interpolation object
        '''
...
class CPD(SetAndLaunchBase):
    ...
    def __init__(self,
        ...
        '''
        Initialize CPD class
        :param coal: coal object
        :param pressure: operating pressure (Pa)
        :param deltaT:
        :param runNr: name of the run (default ;'run0')
        :param resDir: results directory output (default = None)
        :return:
        '''
        self.runNr = runNr
    ...
    def CalcCoalParam(cls, ultim_ana, daf):
        ...
        :param ultim_ana: Ultimate analysis Dict {'Carbon':80,'Hydrogen':10,.....}
        :param daf: Dry ash free dict Dict {'Volatile Matter': 35}
        TODO check if the dat should be passed as percentage
        :return:{'c0'   : val ,'mdel' : val, 'mw'   : val, 'p0'   : val, 'sig'  : val}
        '''
        c=np.array([
               [ 0.0    ,  0.0    ,  0.0     ,  0.0],
...
""".format(**self.output_dict)
    ...
    def writeInDat(self):
        '''
        write input file IN.dat in the writing directory
        '''
    ...
    def Run(self, inp_file="IN.dat", verbose=False):
        ...
        :param inp_file: default 'IN.dat' input file for CPD executable
        :param verbose: default: False
        :return:CPDresult object
        '''
        import pkp.bins
